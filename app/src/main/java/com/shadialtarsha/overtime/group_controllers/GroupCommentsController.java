...
public class GroupCommentsController {
    ...
    public GroupCommentsController(Context context, User currentUser, Post currentPost) {
        mContext = context;
        ...
        public void bindComment(Comment comment) {
            ...
            mFirebaseDatabaseOperations.getSpecificUserNodeReference(mComment.getUserId())
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        @Override
                        public void onCancelled(DatabaseError databaseError) {
                            Log.d(Constants.GROUP_COMMENTS_CONTROLLER, databaseError.getMessage());
                        }
                    })
            ;
