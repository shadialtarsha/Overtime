...
public class AddPostActivity extends AppCompatActivity {
    ...
    private static final String CURRENT_USER_EXTRA = "com.shadialtarsha.overtime.profile_controllers.AddPostActivity.current_user";
    ...
    private void setUpViews() {
        mCancelPostImageButton = (ImageButton) findViewById(R.id.add_post_cancel_image_button);
        mAddPostProfileImageView = (ImageView) findViewById(R.id.add_post_user_profile_photo);
        mPostEditText = (EditText) findViewById(R.id.add_post_edit_text);
        mPostImageFrameLayout = (FrameLayout) findViewById(R.id.add_post_image_frame_layout);
        mPostImageView = (ImageView) findViewById(R.id.add_post_image_image_view);
        mCancelPostIconImageButton = (ImageButton) findViewById(R.id.add_post_cancel_post_icon_image_button);
        mPhotoPickerImageButton = (ImageButton) findViewById(R.id.add_post_photo_picker_image_button);
        mPostTextMaxCharacters = (TextView) findViewById(R.id.add_post_text_max_characters);
        mPostButton = (Button) findViewById(R.id.add_post_button);
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot followers : dataSnapshot.getChildren()) {
                                Follower user = followers.getValue(Follower.class);
                                mFirebaseDatabaseOperations
                                        .getSpecificWallPostsNodeReference(user.getUserId())
                                        .child(mCurrentPost.getPostId())
                                        .setValue(mCurrentPost)
                                ;
                            }
                        ...
                        public void onCancelled(DatabaseError databaseError) {
                            Log.d(Constants.ADD_POST_ACTIVITY, databaseError.getMessage());
                        }
                    })
            ;
